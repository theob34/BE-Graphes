...
public class ShortestPathTest {
    ...
    public static void initAll() throws IOException {
        ...
        RoadInformation carSpeed30 = new RoadInformation(RoadType.MOTORWAY,  new AccessRestrictions(restrictionsAllVehicules), true, 30, ""),
                        carSpeed50 = new RoadInformation(RoadType.MOTORWAY,  new AccessRestrictions(restrictionsAllVehicules), true, 50, ""),
                        carSpeed80 = new RoadInformation(RoadType.MOTORWAY,  new AccessRestrictions(restrictionsAllVehicules), true, 80, ""),
                        carSpeed90 = new RoadInformation(RoadType.MOTORWAY,  new AccessRestrictions(restrictionsAllVehicules), true, 90, ""), 
                        carSpeed110 = new RoadInformation(RoadType.MOTORWAY,  new AccessRestrictions(restrictionsAllVehicules), true, 110, ""),
                        cycleSpeed10 = new RoadInformation(RoadType.CYCLEWAY, new AccessRestrictions(restrictionsCycleOnly), true, 10, ""),
                        cycleSpeed20 = new RoadInformation(RoadType.CYCLEWAY, new AccessRestrictions(restrictionsCycleOnly), true, 20, ""),
                        cycleSpeed30 = new RoadInformation(RoadType.CYCLEWAY, new AccessRestrictions(restrictionsCycleOnly), true, 30, "");
        ...
        b2c = Node.linkNodes(nodes[0], nodes[4], 30, carSpeed30, null);
        b2f = Node.linkNodes(nodes[1], nodes[2], 45, carSpeed90, null);
        c2d = Node.linkNodes(nodes[2], nodes[3], 90, carSpeed30, null);
        c2g = Node.linkNodes(nodes[2], nodes[3], 50, cycleSpeed20, null);
        d2g = Node.linkNodes(nodes[2], nodes[3], 10, cycleSpeed10, null);
        d2f = Node.linkNodes(nodes[3], nodes[0], 220, carSpeed110, null);
        e2h = Node.linkNodes(nodes[3], nodes[4], 10, carSpeed30, null);
        f2g = Node.linkNodes(nodes[4], nodes[0], 45, cycleSpeed30, null);
        ...
        nullPath                = new ShortestPathData(graph, nodes[0], nodes[0], ArcInspectorFactory.getAllFilters().get(0)); // Chemin de a à a, shortest - only cars
    ...
    public void testNormalCarPath() {
        ...
        assertTrue(("Test n° 1 : " + testName + " | chemin Attendu : " + cheminAttendu + "| chemin Trouvé : " + cheminTrouve), cheminAttendu.toString().compareTo(cheminTrouve.toString())==0);
    ...
    public void testImpossiblePath() {
        ...
        cheminAttendu = null;
        cheminTrouve = DijAlgo.run().getPath();
        assertTrue(("Test n° 6 : " + testName + " | chemin Attendu : " + cheminAttendu + "| chemin Trouvé : " + cheminTrouve), cheminAttendu == cheminTrouve);
